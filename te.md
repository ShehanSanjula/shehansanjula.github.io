...
<meta name="description" content="Error-404!"> 
                     ...
                     <nav class="navbar navbar-expand-lg navigation_area">
                        ...
                        <div class="collapse navbar-collapse mainmenu_area" id="navbarNav">
                           <ul class="navbar-nav mainmenu">
                              <li class="nav-item"> <a class="nav-link smoot_scroll dots_effect active" href="https://shehansanjula.me" data-scroll-nav="0">Home <span class="dot_effect dot_hover"></span></a> </li>
 ...
 <image src="https://res.cloudinary.com/shehansanjula-cdn/image/upload/v1634826653/blog/error-404-web.png" alt="404-error-page" width="100%" height="100%">
Test page!!!!!
