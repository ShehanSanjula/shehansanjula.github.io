if (self.CavalryLogger) {
    CavalryLogger.start_js(["Ljhn917"]);
}
...
(function(a) {
    ...
    URL.createObjectURL = function(a) {
        var b = null
          , e = 0;
        a instanceof File ? (b = "File",
        e = a.size) : a instanceof Blob ? (b = "Blob",
        e = a.size) : typeof MediaSource === "function" && a instanceof MediaSource && (b = "MediaSource",
        e = 0);
        a = d.call(URL, a);
        b !== null && (c[a] = {
            type: b,
...
(function(a) {
    ...
    $ = a.Env || {};
    var v = !!$.gk_nonjs_deps_in_require, w = !!$.gk_requirelazy_mem, x = !!$.gk_require_when_ready_in_order, y = !!$.profile_require_factories, z = a.performance || {}, A;
    ...
    function I(d) {
        var g = a.ErrorGuard;
        if (g && !g.inGuard())
            return g.applyWithGuard(I, null, [d]);
        g = e[d];
        if (!g) {
                    ...
                    if (y) {
                        ...
                        if (k.__SMmeta)
                            for (var z in k.__SMmeta)
                                Object.prototype.hasOwnProperty.call(k.__SMmeta, z) && (n[z] = k.__SMmeta[z])
                    }
                }
            } catch (a) {
                g.hasError = !0;
    ...
    function N(b, c, e, g, h, i, l) {
        ...
        n.context = h;
        n.special = g;
        (n.nonJSDeps || ma(n)) && (n.nonJSDeps = !1,
        M(n));
        U(n);
        if (d.length > 0) {
            var o = d;
    ...
    function Y(a, b, c) {
        if (v !== !0)
            return X.call(null, a, b, c);
        var d = e[a];
        if (d && d.nonJSDeps && T(d)) {
            if (typeof b === "function")
                return b(F.call(null, a))
        } else if (typeof c === "function")
            return c()
    }
    $ = {
    ...
    if (a.__rl_stub) {
        for (var Y = 0; Y < a.__rl_stub.length; Y++)
            R.apply(null, a.__rl_stub[Y]);
        delete a.__rl_stub
    }
    G = function() {}
    ;
...
(function(a) {
    ...
    if (b && b.setResourceTimingBufferSize) {
        var c = function(c) {
            b.setResourceTimingBufferSize(c && c.smaller_resource_timing_buffer ? 1e3 : 1e5),
...
__d("gkx", ["invariant", "BanzaiLazyQueue", "ExecutionEnvironment", "emptyFunction"], (function(a, b, c, d, e, f, g, h) {
    ...
    function k(a) {
        ...
        b != null || h(0, 11797, a);
        j[a] || (j[a] = !0,
        (d("ExecutionEnvironment").canUseDOM || d("ExecutionEnvironment").isInWorker) && d("BanzaiLazyQueue").queuePost("gk2_exposure", {
            identifier: a,
            hash: b.hash
        }));
        return b.result
        ...
        goFragment: function(a) {
            if (c("Env").isCQuick) {
                ...
                if (a.getFragment()) {
                    ...
                    if (c("areEqual")(new (c("URI"))(b).setFragment("").getQualifiedURI(), new (c("URI"))(a).setFragment("").getQualifiedURI()))
                        return !0
                }
            }
            return !1
        ...
        b.getURIBuilder = function(a) {
            ...
            if (a) {
                ...
                Object.keys(this.$2).forEach(function(a) {
                    ...
                    e = "get" + e + c.type;
                    e = d[e](a);
                    if (e == null || Object.prototype.hasOwnProperty.call(c, "defaultValue") && e === c.defaultValue)
                        return;
                    c = "set" + c.type;
                    b[c](a, e)
                }, this)
...
__d("getSameOriginTransport", ["ExecutionEnvironment", "err"], (function(a, b, c, d, e, f) {
    function c() {
        if (!b("ExecutionEnvironment").canUseDOM)
            throw b("err")("getSameOriginTransport: %s", "Same origin transport unavailable in the server environment.");
        try {
...
__d("JSResourceReference", ["JSResourceEvents", "Promise", "PromiseAnnotate", "ifRequireable", "ifRequired"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        ;
        e.preload = function() {
            var a, b = this, c = (a = this.$2) != null ? a : l;
            k(function(a) {
...
__d("promiseDone", ["Env", "ErrorPubSub", "getErrorSafe"], (function(a, b, c, d, e, f) {
    var g, h;
    function a(a, c, d) {
        var e, f = (e = (g || (g = b("Env"))).deferred_stack_trace_rate) != null ? e : 0, i = null;
    ...
    f = function() {
        ...
        d.$2 = function(a) {
            var b = this
              ...
              , e = !1
              , f = function(b, f) {
                d == null ? void 0 : d(c("performanceNow")(), f),
                e || a(b)
            };
    ...
    function a(a, b) {
        return function(d) {
            ...
            try {
                ...
                if (c("TrustedTypesConfig").reportOnly)
                    return "" + d;
                throw a
            }
        }
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "ClientConsistency", "ErrorPubSub", "FBLogger", "JSResourceReference", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "TimeSlice", "cr:696703", "createTrustedScriptURLFromBootloaderDataURI", "createTrustedScriptURLFromFacebookURI", "err", "fb-error", "ifRequireable", "nullthrows", "performanceAbsoluteNow", "performanceNow", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i, j, k = b("fb-error").TAAL, l = b("CSRIndexUtil").UNKNOWN_RESOURCE_INDEX, m = b("CSRIndexUtil").parseCSRIndexes, n = function() {}, o = new Set(), p = !!b("BootloaderConfig").deferBootloads;
    ...
    function L(a) {
        var c = v.get(a);
        if (!c)
            throw k.blameToPreviousFile(b("err")("Bootloader: %s is not in the component map", a));
        return c
    }
    function M(a) {
        var c = L(a);
        c.be && (delete c.be,
        $.done(b("ResourceHasher").getAsyncHash(a)))
    }
    function N(a) {
        var c = x.get(a);
        if (!c)
            throw k.blameToPreviousFile(b("err")("No resource entry for hash: %s", a));
        return c
    }
    function ba(a, c) {
    ...
    function Q() {
        ...
        if (a < I)
            return !0;
        a = A[a - 1] - A[a - I];
        a < J && (b("FBLogger")("bootloader").warn("JS retry abort"),
        K = !1);
        return K
    }
    function ca(a, b, c) {
    ...
    function S(a, c, d, e) {
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            z.set(f, h + 1)) : (u.set(c, k),
            b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, f, k - g, h, s.size - t.size),
            b("NetworkStatus").reportError(),
            e())
        })
    }
    function T(a, c, d) {
        return function() {
            b("FBLogger")("bootloader").warn("CSS timeout [%s] at %s | concurrency: %s", a, c.src, s.size - t.size),
    ...
    function U(a, c, d, e, f) {
        ...
        r = b("cr:696703").getUserBlockingRunAtCurrentPriCallbackScheduler_DO_NOT_USE());
        var u = c.onBlocking
          , v = c.onAll
          , w = c.onLog;
        ...
        setResourceMap: function(a, c, d, e) {
            ...
            for (var g in a) {
                ...
                var h = a[g]
                  , i = x.get(g);
                !i ? (h.type === "js" && (f = !0),
                V(g, h, !1)) : (e && e.dup_rsrc++,
                (i.type === "js" && h.type === "js" || i.type === "css" && h.type === "css") && (h.d && !i.d && (h.type === "js" && (f = !0),
                i.src = h.src,
                i.d = 1)))
            }
    ...
    function i(a, e, f) {
        ...
        if (Array.isArray(g))
            ...
            if (g.__m)
                ...
                e[f] = new (b.call(null, "JSResourceReference"))(g.__jsr).__setRef("replaceTransportMarkers");
            else if (g.__dr)
    ...
    var h = new Set(c("InitialCookieConsent").initialConsent)
      ...
      , j = {
        ...
        isThirdPartyIframeAllowed: function(a) {
            if (j.isCookiesBlocked() || !j.hasConsent(1))
                return !1;
...
__d("WebStorage", ["CookieConsent", "FBLogger", "err", "isQuotaExceededError"], (function(a, b, c, d, e, f, g) {
    ...
    function o(a) {
        ...
        try {
            ...
            if (c("isQuotaExceededError")(b, a) === !0)
                return !0
        }
        return !1
    }
    ...
    a = {
        ...
        getKeyFromLocalStorage: function(a) {
            var b;
            return (b = l(i, m, j)) == null ? void 0 : b.getItem(a)
        },
        getSessionStorage: function() {
            return l(h, n, k)
        },
        getKeyFromSessionStorage: function(a) {
            var b;
            return (b = l(i, m, k)) == null ? void 0 : b.getItem(a)
        },
...
__d("getAsyncParams", ["CSRBitMap", "CometPersistQueryParams", "CurrentCommunity", "CurrentUserInitialData", "DTSG", "DTSGUtils", "DTSG_ASYNC", "Env", "ISB", "JSErrorLoggingConfig", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebConnectionClassServerGuess", "WebSession", "asyncParams", "isSocialPlugin", "uniqueRequestID"], (function(a, b, c, d, e, f) {
    var g, h, i = b("JSErrorLoggingConfig").sampleWeight, j = b("JSErrorLoggingConfig").sampleWeightKey, k = {
        locale: !0,
        cxobfus: !0,
        js_debug: !0,
        cquick: !0,
    ...
    function a(a) {
        ...
        (h || (h = b("Env"))).isCQuick && !e.cquick && (e.cquick = (h || (h = b("Env"))).iframeKey,
        e.ctarget = h.iframeTarget,
        e.cquick_token = h.iframeToken);
        if (a == "POST") {
            c = b("DTSG").getCachedToken ? b("DTSG").getCachedToken() : b("DTSG").getToken();
            c && (e.fb_dtsg = c,
            b("SprinkleConfig").param_name && (e[b("SprinkleConfig").param_name] = b("DTSGUtils").getNumericValue(c)));
            b("LSD").token && (e.lsd = b("LSD").token,
            b("SprinkleConfig").param_name && !c && (e[b("SprinkleConfig").param_name] = b("DTSGUtils").getNumericValue(b("LSD").token)))
        }
        if (a == "GET") {
            d = b("DTSG_ASYNC").getCachedToken ? b("DTSG_ASYNC").getCachedToken() : b("DTSG_ASYNC").getToken();
            d && (e.fb_dtsg_ag = d,
            b("SprinkleConfig").param_name && (e[b("SprinkleConfig").param_name] = b("DTSGUtils").getNumericValue(d)))
        }
...
__d("bx", ["unrecoverableViolation"], (function(a, b, c, d, e, f, g) {
    ...
    a.add = function(a, b) {
        ...
        for (var d in a)
            b && b.entry++,
            !(d in h) ? (a[d].loggingID = d,
            h[d] = a[d]) : b && b.dup_entry++
    }
    ;
    a.getURL = function(a) {
        return a.uri
...
__d("ix", ["invariant", "nullthrows"], (function(a, b, c, d, e, f, g, h) {
    ...
    b.add = function(a, b) {
        ...
        for (var d in a)
            b && b.entry++,
            !(d in i) ? (a[d].loggingID = d,
            i[d] = a[d]) : b && b.dup_entry++
    }
    ;
        ...
        if (b.addEventListener) {
            ...
            if (e && e[1] < 525)
                var f = a.setInterval(function() {
                    /loaded|complete/.test(b.readyState) && (r(),
                    a.clearInterval(f))
                }, 10);
            else
                b.addEventListener("DOMContentLoaded", r, !0)
        } else {
...
__d("UserTimingUtils", ["performance"], (function(a, b, c, d, e, f, g) {
    ...
    function f(a, b) {
        i && (c("performance").measure(a, b),
        c("performance").clearMeasures(a))
    }
    function l(a, b) {
        i && (c("performance").mark(a, b),
        c("performance").clearMarks(a))
    }
    g.measureStart = a;
    g.measureEnd = b;
...
__d("DOMPurify", [], (function(a, b, c, d, e, f) {
    (function(b, c) {
        typeof f === "object" && typeof e !== "undefined" ? e.exports = c() : typeof define === "function" && define.amd ? define(c) : (b = b || self,
        b.DOMPurify = c())
    }
    )(this, function() {
        "use strict";
        ...
        var ta = function() {
          ...
          , ua = function(a, b) {
            if ((typeof a === "undefined" ? "undefined" : A(a)) !== "object" || typeof a.createPolicy !== "function")
                return null;
            var c = null
        ...
        function va() {
            ...
            var J = ma
              ...
              , cb = function(a) {
                ...
                s(N, y),
                s(N, z)),
                U.svgFilters === !0 && (s(M, w),
                s(N, y),
                s(N, z)),
                U.mathMl === !0 && (s(M, x),
                s(N, la),
                s(N, z)));
                a.ADD_TAGS && (M === La && (M = t(M)),
                s(M, a.ADD_TAGS));
                a.ADD_ATTR && (N === Ma && (N = t(N)),
                s(N, a.ADD_ATTR));
            ...
            var gb = "http://www.w3.org/1998/Math/MathML"
              ...
              , ib = function(a) {
                ...
                if (a.namespaceURI === X) {
                    if (b.namespaceURI === hb && !eb[d])
                        return !1;
                    if (b.namespaceURI === gb && !db[d])
                        return !1;
              ...
              , mb = function(a) {
                if (a instanceof q || a instanceof r)
                    return !1;
              ...
              , nb = function(a) {
                ...
                O && a.nodeType === 3 && (c = a.textContent,
                c = o(c, J, " "),
                c = o(c, K, " "),
                a.textContent !== c && (m(b.removed, {
                    element: a.cloneNode()
                }),
                a.textContent = c));
              ...
              , pb = function(a) {
                var c, d = void 0, e = void 0, f = void 0;
            ...
            b.sanitize = function(d, f) {
                ...
                if (!b.isSupported) {
                    if (A(a.toStaticHTML) === "object" || typeof a.toStaticHTML === "function") {
                        if (typeof d === "string")
                            return a.toStaticHTML(d);
                        if (Z(d))
                            return a.toStaticHTML(d.outerHTML)
                    }
                    return d
                }
                Sa || cb(f);
                ...
                if (!T)
                    if (d instanceof h)
                        ...
                        f.nodeType === 1 && f.nodeName === "BODY" ? g = f : f.nodeName === "HTML" ? g = f : g.appendChild(f);
                    else {
...
__d("BigPipe", ["$", "Arbiter", "BigPipeExperiments", "BigPipeInstance", "BigPipePlugins", "Bootloader", "ErrorUtils", "FBLogger", "HasteResponse", "JSCC", "PageEvents", "PageletEventConstsJS", "PageletSet", "RunBlue", "ServerJS", "TimeSlice", "UserTimingUtils", "captureUsageSnapshot", "clearTimeout", "createTrustedFunction", "createTrustedScriptWithoutValidation_DO_NOT_USE", "fastDeepCopy", "ge", "gkx", "performanceAbsoluteNow", "requireDeferred", "setTimeout"], (function(a, b, c, d, e, f, g) {
    ...
    function l(a, b) {
        if (a)
            for (var d = 0; d < a.length; d++)
                c("ErrorUtils").applyWithGuard(c("createTrustedFunction")(c("createTrustedScriptWithoutValidation_DO_NOT_USE")(a[d])), b)
    }
    var m = 1;
    b = function() {
        function a(b) {
        ...
        b._nextPhase = function() {
            this.config.flush_pagelets_asap ? h <= 8 ? c("setTimeout")(this._tryRenderingNextPhase.bind(this), 20) : this._tryRenderingNextPhase() : (this._currentPhase++,
            h <= 8 ? c("setTimeout")(this._beginPhase.bind(this, this._currentPhase), 20) : this._beginPhase(this._currentPhase))
        }
        ;
        ...
        b._informEventExternal = function(a, b, d) {
            ...
            i && (console.timeStamp && console.timeStamp(a + " " + (Object.prototype.hasOwnProperty.call(b, "arbiter") ? JSON.stringify(babelHelpers["extends"]({}, b, {
                arbiter: null
            })) : JSON.stringify(b)))),
...
__d("DefaultTrustedTypePolicies", ["Env", "URI", "err", "isCdnURI", "isFacebookDotNetURI", "isFacebookURI"], (function(a, b, c, d, e, f, g) {
    "use strict";
    function a() {
        if (c("Env").enableDefaultTrustedTypePolicy === !1)
            return;
        if (typeof trustedTypes !== "undefined") {
            ...
            a.createPolicy("default", {
                createScriptURL: function(a, b) {
                    ...
                    if (b != null && (c("isFacebookURI")(b) || c("isCdnURI")(b) || c("isFacebookDotNetURI")(b)))
                        return a;
...
__d("getMarkupWrap", ["invariant", "ExecutionEnvironment", "createTrustedHTMLForLinkTag"], (function(a, b, c, d, e, f, g, h) {
    ...
    function a(a) {
        ...
        Object.prototype.hasOwnProperty.call(j, a) || (a === "*" ? i.innerHTML = c("createTrustedHTMLForLinkTag")("<link />") : i.innerHTML = "<" + a + "></" + a + ">",
        j[a] = !i.firstChild);
        return j[a] ? l[a] : null
    }
    g["default"] = a
...
__d("Event", ["$", "Arbiter", "DOMEvent", "DOMEventListener", "DOMQuery", "DataStore", "Env", "ErrorGuard", "EventProfiler", "ExecutionEnvironment", "FBLogger", "Parent", "Scroll", "TimeSlice", "UserAgent", "clickRefAction", "dedupString", "fb-error", "getDocumentScrollElement", "getObjectValues"], (function(a, b, c, d, e, f) {
    ...
    var t = b("EventProfiler").__wrapEventListenHandler(function(a, c) {
        ...
        if (a == "click" || a == "contextmenu" || a == "mousedown" && c.which == 2) {
            ...
            (g || (g = b("Env"))).gk_no_ref_action != !0 && (a == "click" && b("clickRefAction")("click", f, c),
...
__d("PhotoSnowliftLoader", ["Arbiter", "Bootloader", "FBLogger", "PageEvents", "getSurfaceAwareContainer", "ifRequired", "snowliftLoadingSpinner"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b, d) {
        var e = this;
        c("Bootloader").loadModules(["URI"], function(f) {
            m = "";
            k();
            ...
            h = r(h, a, b, g);
            if (h) {
                b.getAttribute("data-ploi") && (h = new Image(),
                h.src = new f(s(b)));
                e.loadWithSnowLift(a, b, g, d)
            }
        }, "PhotoSnowliftLoader")
    }
    function b(a, b, d, e) {
...
__d("CookieCore", ["CookieCoreConfig", "CookieStore"], (function(a, b, c, d, e, f, g) {
    var h = /^.*(\.(facebook|messenger|oculus|instagram|workplace)\..*)$/i, i = /_js_(.*)/, j;
    function k() {
        j || (j = d("CookieStore").newCookieStore());
        return j
    }
    function l() {
        if (h.test(window.location.hostname))
            return window.location.hostname.replace(h, "$1");
        else
            return window.location.hostname.replace(/^.*(\.(?:[^.]+)\.(?:[^.]+))$/, "$1")
    }
    function m(a) {
...
__d("Primer", ["invariant", "Bootloader", "CSS", "Env", "Event", "Parent", "PhotoSnowliftLoader", "PrimerInlineHandlers", "ReactServerPrimer", "TimeSlice", "clickRefAction", "firstClickTimestamp", "ifRequired", "performanceNow", "requireDeferred", "trackReferrer"], (function(a, b, c, d, e, f, g, h) {
    ...
    b = function(a, b) {
        ...
        n();
        a === "mouseover" && (o(),
        c == null && m && (c = d("ReactServerPrimer").handleEvent("data-sr-onmouseover", b, m)))
    }
    ;
    e = function(a, b) {
        b = b || window.event,
...
__d("SidebarPrelude", ["Arbiter", "Bootloader", "CSS", "ChatConfig", "URI", "setTimeout"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a) {
        ...
        if (b) {
            var e = i || h && !this.isOnHomepage();
            e ? d("CSS").addClass(b, j) : (d("CSS").removeClass(b, j),
            h && c("setTimeout")(function() {
                c("Bootloader").loadModules(["Dock"], function(a) {
                    a.resizeAllFlyouts()
                }, "SidebarPrelude")
            }));
            b.clientWidth > a && (d("CSS").addClass(b, k),
    ...
    function b() {
        ...
        if (a) {
            var b = i || h && !this.isOnHomepage();
            b ? d("CSS").addClass(a, j) : (d("CSS").removeClass(a, j),
            h && c("setTimeout")(function() {
                c("Bootloader").loadModules(["Dock"], function(a) {
                    a.resizeAllFlyouts()
                }, "SidebarPrelude")
...
__d("Visibility", ["BaseEventEmitter", "ExecutionEnvironment", "TimeSlice"], (function(a, b, c, d, e, f, g) {
    var h, i;
    d("ExecutionEnvironment").canUseDOM && (document.hidden !== void 0 ? (h = "hidden",
    i = "visibilitychange") : document.mozHidden !== void 0 ? (h = "mozHidden",
    i = "mozvisibilitychange") : document.msHidden !== void 0 ? (h = "msHidden",
    i = "msvisibilitychange") : document.webkitHidden !== void 0 && (h = "webkitHidden",
